...
<form action="{{ URL::route('admin-job-creator-post') }}" method="post" enctype="multipart/form-data" files="true">
            ...
            <div class="form-group @if($errors->has('job_type')) has-error has-feedback @endif">
                ...
                <select name="job_type" id="job_type" class="form-control">
                    @foreach($job_types as $job_type)
                        <option value="{{ $job_type->job_type_slug }}">{{ $job_type->job_type }}</option>
                    @endforeach
                </select>
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                        <label for="highlighted">
                            <input type="checkbox" id="highlighted" name="highlighted" value="highlighted"> Highlighted (Mark this job as highlighted? And display in other color on frontpage)
                        </label>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            ...
            <textarea name="custom_form" id="custom_form" cols="30" rows="10" class="form-control"></textarea>
        </div>
    </div>
